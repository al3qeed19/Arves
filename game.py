...
class GameWindow(ui.ScriptWindow):
	...
	def __BuildKeyDict(self):
		...
		onPressKeyDict[app.DIK_F5]	= lambda : self.__Bonuschangevalue()
...
# Loophole double Block Property 10 sec
...
# Loophole double Block Property 10 sec
	...
	def __ServerCommand_Build(self):
		serverCommandList={
			...
			# D.ESCAPE NEW_EFFECTS START #
			"DEscapeZirhliAt"					: self.__DEscapeZirhliAt,
			"DEscapeAskerAt"					: self.__DEscapeAskerAt,
			# D.ESCAPE NEW_EFFECTS FINISH #
	...
	def __DEscapeZirhliAt(self):
		net.SendChatPacket("(DEscapeZirhliAt)")
		
	def __DEscapeAskerAt(self):
		net.SendChatPacket("(DEscapeAskerAt)")
	...
	def SetPetEvolution(self, evo):
		petname = ["بري", "بري وحشي", "بري قوي", "تدريب الأبطال"]
	...
	def __Switch(self):
		...
		for eachSlot in xrange(player.INVENTORY_PAGE_SIZE*4):
			...
			if itemVNum == int(Boniswitchvalue):
				net.SendItemUseToItemPacket(eachSlot, (int(SelectedIndex)))
				break
